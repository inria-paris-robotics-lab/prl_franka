...
def generate_launch_description():
    # Config file
    rviz_config_file = PathJoinSubstitution([FindPackageShare("prl_franka_description"), "rviz", "config.rviz"])
    ...
    robot_description_content = Command(
        [
            ...
            " ", 
            PathJoinSubstitution([FindPackageShare("prl_franka_description"), "urdf", "prl_franka.urdf.xacro"]),
            " ",
        ]
    )
